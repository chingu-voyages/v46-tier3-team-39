export default function Video() {
    return (
        <div className="py-5 px-6 text-center max-w-2xl m-auto">
            <h1 className="font-bold text-3xl">Empowering students to succeed through innovative AI-driven exam preparation.</h1>
            <p className="mt-2">
