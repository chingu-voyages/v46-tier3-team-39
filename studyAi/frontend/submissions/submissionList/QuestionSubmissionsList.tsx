"use client";
import PaginationWrapper from "../../utils/components/pagination/paginationWrapper";
import { useSession } from "next-auth/react";
import { useLazyQuery } from "@apollo/client";
import { useQuestionId } from "../../questions/singleQuestion/context/QuestionIdContext";
import { QueryFullQuestionSubmissions } from "../../gql/queries/questionSubmissionQueries";
import { memo, useCallback, useState } from "react";
import MemoizedQuestionSubmissionsListItem from "../submissionListItem/QuestionSubmissionListItem";
import { useQuestions } from "../../stores/questionStore";
import { QuestionSubmission } from "@prisma/client";
import { useQuestionSubmissions } from "../../stores/questionSubmissionsStore";
import fetchItems from "@/frontend/submissions/submissionPagination/fetchNewData";
import Container from "@mui/material/Container";
import Typography from "@mui/material/Typography";
import { styles } from "./styles";
import useWindowWidth from "../../hooks/useWindowWidth";
import { arePropsEqual } from "@/frontend/submissions/submissionList/arePropsEqual";
import { listItemProps } from "@/frontend/submissions/submissionListItem/listItemProps";
