...
import { QuestionInfoData } from "../../../../../backend/prisma/generated/type-graphql";
import { useQuestionModal } from "../../context/questionModalProvider";
import { TextFieldInput } from "../../../../auth/components/FormInputs";
import { TextAreaAutoResizeInput } from "../../../../utils/components/inputs/TextAreaAutoResizeInput";
...
const QuestionTagsInput = dynamic(
  () =>
    import(
      "@/frontend/questions/questionModal/components/questionEditor/questionTagsInput"
